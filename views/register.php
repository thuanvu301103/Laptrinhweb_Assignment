      ...
      <div class="d-flex flex-row justify-content-around account-info ">
        <div class="col-lg-5 m-2 text-start">
          <div class="form-group">
            ...
            <input type="text" name="username" placeholder="Username/Email" id="Username" class="my-3 form-control text-secondary border border-0  rounded-pill form-control" rules="required" />
            <span class="form-message" id="uname"></span>
          </div>

          <div class="form-group">
            <label>Password:</label>
            <input type="password" name="password" placeholder="Password" id="Password" class="my-3 form-control text-secondary border border-0  rounded-pill form-control" rules="required|min:6" />
            <span class="form-message"></span>
          </div>

          <div class="form-group">
            <label>Re-enter Password:</label>
            <input type="password" name="password2" placeholder="Re-type password" id="RetypePassword" class="my-3 form-control text-secondary border border-0  rounded-pill form-control" rules="required" />
            <span class="form-message"></span>
          </div>
        </div>
        ...
        <div class="col-lg-5 m-2 text-start">
          <div class="form-group">
            ...
            <input type="text" name="firstname" placeholder="First Name" id="Firstname" class="my-3 form-control text-secondary border border-0  rounded-pill form-control" rules="required" />
            <span class="form-message"></span>
          </div>

          <div class="form-group">
            <label>Last name:</label>
            <input type="text" name="lastname" placeholder="Last Name" id="Lastname" class="my-3 form-control text-secondary border border-0  rounded-pill form-control" rules="required" />
            <span class="form-message"></span>
          </div>

          <div class="form-group">
            <label>Phone number:</label>
            <input type="text" name="phone" placeholder="Phone" id="Phone" class="my-3 form-control text-secondary border border-0  rounded-pill form-control" rules="required" />
            <span class="form-message"></span>
          </div>

          <label>Date of birth:</label>
          <input name="date" class="my-3 form-control text-secondary border border-0  rounded-pill form-control" type="date">
          ...
          <div class="d-flex flex-row text-center py-3">
            <input class="btn btn-dark rounded-pill signin-btn" style="width: 15rem; margin-right: 2rem;" id="sign-up-button" type="submit" name="signup_submit" value="Sign me up" />
            <input class="btn btn-light rounded-pill signin-btn border border-2 border-dark" style="width: 15rem;" id="back-to-login" onclick="location.href='./login.php';" value="Back to Login"></button>
          </div>
        </div>
      </div>
